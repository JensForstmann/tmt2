...
import { App } from './App';
import { PlayersStatsPage, PlayerStatsPage, MatchesStatsPage, MatchStatsPage, DataManagementStatsPage } from './pages/stats';
...
render(
	() => (
		<Router root={App}>
			...
			<Route path="/stats/data" component={DataManagementStatsPage} />
